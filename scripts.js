var userNumeros = [];
var intentos = 1;
var lista = document.getElementById("ulListado"); //toma del documento el div "listado"
var resultado = document.getElementById("resultado"); //toma del documento el div "resultado"
var pista = document.getElementById("pista");
var numeroElegido = randomNumber(); //toma un numero aleatoriamente que será el numero a elegir. 
function hello() {
...
function randomNumber() {
    var randomNumber = Math.floor(Math.random() * 100) + 1; //hace el numero aleatorio
